#
# As per docs on download site: http://c0re.23.nu/c0de/IPy/
#
# redistribution: If you think you need a license for anything 
# you might think of this as beeing unter a "BSD Style License".
# 
