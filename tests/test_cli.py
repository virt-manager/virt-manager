...
c.add_compare("--os-variant fedora-unknown --file %(EXISTIMG1)s --location %(TREEDIR)s --cloud-init", "tree-media-and-cloud-init", prerun_check=has_old_osinfo)  # Use --location and --cloud-init at the same time
